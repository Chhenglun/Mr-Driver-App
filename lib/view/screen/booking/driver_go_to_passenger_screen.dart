...
class _DriverPickPassengerState extends State<DriverPickPassenger> {
  ...
  LatLng passengerPosition = LatLng(0, 0);
  ...
  Set<Marker> _markers() {
    ...
    if (userTripInfoDetail != null) {
      ...
      if (userTripInfoDetail["end_location"]["coordinates"] != null) {
        endLatLng = LatLng(
            userTripInfoDetail["end_location"]["coordinates"][1],
  ...
  void getPolyPoints() async {
    ...
    PolylineResult resultDriverToPassenger = await polylinePoints.getRouteBetweenCoordinates(
    ...
    if (resultDriverToPassenger.points.isNotEmpty) {
      ...
      resultDriverToPassenger.points.forEach((PointLatLng point) {
        polyLineCoordinatesDriverToPassenger.add(LatLng(point.latitude, point.longitude));
      });
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: ElevatedButton(
                                        ...
                                        onPressed: () {
                                          nextScreenNoReturn(context, DriverStartPickPasssenger());
                                        },
                                        child: Text(
